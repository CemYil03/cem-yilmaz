...
independent of the document gutter — see [chat.md](./chat.md). On those surfaces, also avoid `scrollbar-width: none` while the bar is meant
to stay reserved: it collapses the stable gutter (the streaming layout-shift case).
