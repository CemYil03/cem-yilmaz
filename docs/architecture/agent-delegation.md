...
| Orchestrator                                        | `src/server/agents/agentPersonalAssistant.ts` (registers `delegateToProjects`, `delegateToMedia`, `delegateToMedical`, `delegateToTravel`, `delegateToNutrition`, `delegateToFitness`, `delegateToWebSearch`)                                                                                           |
