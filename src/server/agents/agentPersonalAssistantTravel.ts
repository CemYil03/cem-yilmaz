...
function buildSystemPrompt(snapshot: string): string {
    return [
        ...
        'for it (surgical vs. whole-trip, root vs. nested) and how its inputs are shaped; the cross-tool workflow',
        'rules below are all the tool guidance you need beyond those descriptions.',
        '',
        currentDateForAgent(),
        '',
        'Rules:',
