...
export async function cvSummaryForAgent(serverRuntime: ServerRuntime): Promise<string> {
    ...
    return [
        ...
        '- Wohnt in Deutschland (Zeitzone Europe/Berlin, UTC+1 Winter / UTC+2 Sommer).',
        '- Arbeitet regelmäßig mit Teams in Kanada, den USA und Indien zusammen.',
        '- Zeitlich flexibel: frühe Calls ab ca. 7 Uhr DE und späte Calls bis ca. 22 Uhr DE sind normal.',
        '',
        '## Berufserfahrung',
