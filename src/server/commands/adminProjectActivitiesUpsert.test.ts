...
import { adminProjectActivitiesUpsert } from './adminProjectActivitiesUpsert';
...
describe('adminProjectActivitiesUpsert — atomic attach', () => {
...
describe('adminProjectActivitiesUpsert — direction normalization', () => {
