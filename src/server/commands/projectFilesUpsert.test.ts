...
import { projectFilesDelete } from './projectFilesDelete';
import { projectFilesUpsert } from './projectFilesUpsert';
...
describe('projectFilesUpsert', () => {
    it('creates a file row referencing an existing upload', async () => {
        ...
        const result = await projectFilesUpsert(
    ...
    it('updates label / kind / pinned without changing the upload', async () => {
        ...
        const created = await projectFilesUpsert(
            requestingSession.userId!,
...
describe('projectFilesDelete', () => {
    it('removes the row, leaving the underlying upload in place', async () => {
        ...
        await projectFilesDelete(requestingSession.userId!, [fileId], requestingSession, serverRuntime);
