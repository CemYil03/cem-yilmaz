...
import type { GqlSAdminMutationAdminMediaChannelReorderArgs, GqlSMutationResult, GqlSSession } from '../graphql/generated';
...
export async function adminMediaChannelReorder(
    userId: string,
