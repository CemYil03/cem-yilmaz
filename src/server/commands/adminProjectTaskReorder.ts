...
import type { GqlSAdminMutationAdminProjectTaskReorderArgs, GqlSMutationResult, GqlSSession } from '../graphql/generated';
...
// call is meaningless.
export async function adminProjectTaskReorder(
    userId: string,
