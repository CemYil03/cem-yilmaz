...
import type { GqlSMovie, GqlSSession } from '../graphql/generated';
...
export async function adminMediaMovieFindMany(requestingSession: GqlSSession, serverRuntime: ServerRuntime): Promise<GqlSMovie[]> {
    try {
