import type { AdminInventoryItem } from '../db/schema';
import type { GqlSAdminInventoryItem } from '../graphql/generated';
...
export function toGqlAdminInventoryItem(row: AdminInventoryItem): GqlSAdminInventoryItem {
    return {
        itemId: row.itemId,
